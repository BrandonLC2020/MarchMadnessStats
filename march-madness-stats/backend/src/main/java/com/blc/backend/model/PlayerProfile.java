...
/**
 * Main class representing the entire Player Profile JSON response.
...
/**
 * Represents a single season in a player's profile.
 */
class Season {
    @JsonProperty("id")
    private String id;
...
/**
 * Represents a team a player played for in a season.
 */
class Team {
    @JsonProperty("id")
    private String id;
...
/**
 * Represents the total statistics for a player in a season.
 */
class TotalStats {
...
/**
 * Represents the average statistics for a player in a season.
 */
class AverageStats {
    @JsonProperty("minutes")
